...
public class Ejercicio12v2 {
	...
	public static void main(String[] args) {
		...
		//Limpiamos el buffer de teclado, porque falla la lectura del caracter
		//despues de haber leido un dato numerico, ya que esta recogiendo la 
		//"basura" que hay en el buffer
		sc.nextLine();
