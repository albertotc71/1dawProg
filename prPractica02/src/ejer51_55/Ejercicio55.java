...
/**
 * Supongamos que una importante empresa de electrodomésticos nos contrata para resolver un problema
...
public class Ejercicio55 {
	...
	public static void main(String[] args) {
		...
		int almacenes=0, electrodomesticos=200, capacidadTotal=0;
		
		while(electrodomesticos<100000) {
			System.out.println("Almacenes a "+almacenes+" kilometros con capacidad para "+electrodomesticos+" electrodomesticos");
		...
		System.out.println("La capacidad total de los almacenes es de: "+capacidadTotal+" electrodomesticos");
